<?php
    ...
    $dosen = $_GET["id_dosen"];
    $dsn = query("SELECT * FROM dosen WHERE id_dosen = '$dosen'")[0];
...
<html lang="en">
    ...
    <form action = "" method = "post">
        ...
        <div class="row mb-3">
            ...
            <input type="text" class="form-control" id="nama_dsn" name = "nama_dsn" value="<?= $dsn["nama_dsn"]; ?>">
        ...
        <div class="row mb-3">
            ...
            <input type="date" class="form-control" id="tanggalLahir" name = "tanggalLahir" value="<?= $dsn["TanggalLahir"]; ?>">
            
        </div>

        <div class="row mb-3">
            <label for="nim" class="form-label">Alamat</label>
            <input type="text" class="form-control" id="alamat" name = "alamat" value="<?= $dsn["Alamat"]; ?>">
